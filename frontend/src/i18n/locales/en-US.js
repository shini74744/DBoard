...
export default {
    ...
    dashboard: {
        ...
        viewDetails: 'Details',
        viewTrafficBreakdown: 'View traffic quota details',
        trafficBreakdownTitle: 'Traffic quota details',
        baseTraffic: 'Plan quota',
        timedBonus: 'Time-limited gift',
        expiresOn: 'Expires',
        cycleBonus: 'Current cycle gift',
        continuingBonus: 'Continuing gift',
        giftCardBonus: 'Gift card bonus',
        totalQuota: 'Current total quota',
        usedTraffic: 'Used traffic',
        pendingTrafficHint: 'The gift is recorded and becomes available when a valid plan starts.',
        expiredTrafficHint: 'The plan has expired. Old continuing gifts are cleared when a new plan is purchased.',
        continuingBonusHint: 'Continuing gifts survive resets and uninterrupted renewals. They end after a lapse.',
        remainingDays: 'Remaining Days',
        viewDailyUsage: 'View daily data usage',
        dailyUsage: 'Daily data usage',
        last30Days: 'Last 30 days',
        dailyUsageHint: 'Daily upload and download totals for this account. Past usage remains visible after a traffic reset.',
        loadingDailyUsage: 'Loading daily usage…',
        dailyUsageError: 'Daily usage is temporarily unavailable',
        retry: 'Retry',
