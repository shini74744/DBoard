...
export default {
    ...
    dashboard: {
        ...
        viewDetails: '查看明细',
        viewTrafficBreakdown: '查看流量额度明细',
        trafficBreakdownTitle: '流量额度明细',
        baseTraffic: '套餐基础流量',
        timedBonus: '限时加送',
        expiresOn: '到期',
        cycleBonus: '本周期加送',
        continuingBonus: '持续加送',
        giftCardBonus: '礼品卡加送',
        totalQuota: '当前总额度',
        usedTraffic: '已用流量',
        pendingTrafficHint: '赠送已记录，开通有效套餐后生效。',
        expiredTrafficHint: '套餐已过期；旧持续加送额度在重新购买套餐时清除。',
        continuingBonusHint: '持续加送在有效套餐的重置和连续续费后保留；到期断档后新购会清除。',
        remainingDays: '剩余天数',
        viewDailyUsage: '查看每天的流量用量',
        dailyUsage: '每日流量用量',
        last30Days: '最近 30 天',
        dailyUsageHint: '按天汇总当前账号的上传和下载流量；重置后会继续显示历史用量。',
        loadingDailyUsage: '正在读取每日用量…',
        dailyUsageError: '每日用量暂时无法加载',
        retry: '重试',
        totalUsed: '总用量',
        upload: '上传',
        download: '下载',
