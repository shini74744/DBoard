...
export default {
  ...
  dashboard: {
    ...
    viewDetails: '查看明細',
    viewTrafficBreakdown: '查看流量額度明細',
    trafficBreakdownTitle: '流量額度明細',
    baseTraffic: '套餐基礎流量',
    timedBonus: '限時贈送',
    expiresOn: '到期',
    cycleBonus: '本週期贈送',
    continuingBonus: '持續贈送',
    giftCardBonus: '禮品卡贈送',
    totalQuota: '目前總額度',
    usedTraffic: '已用流量',
    pendingTrafficHint: '贈送已記錄，開通有效套餐後生效。',
    expiredTrafficHint: '套餐已過期；舊持續贈送額度在重新購買套餐時清除。',
    continuingBonusHint: '持續贈送在有效套餐重置和連續續費後保留；到期中斷後新購會清除。',
    remainingDays: '剩餘天數',
    accountBalance: '帳戶餘額',
    permanent: '永久',
    none: '無',
