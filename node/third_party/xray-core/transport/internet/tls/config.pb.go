...
type Config struct {
	...
	// DBoard managed front identity. Empty authorities with require=true deny all clients.
	RequireClientCertificate     bool     `protobuf:"varint,23,opt,name=require_client_certificate,json=requireClientCertificate,proto3" json:"require_client_certificate,omitempty"`
	ClientCertificateAuthorities [][]byte `protobuf:"bytes,24,rep,name=client_certificate_authorities,json=clientCertificateAuthorities,proto3" json:"client_certificate_authorities,omitempty"`
	SendClientCertificate        bool     `protobuf:"varint,25,opt,name=send_client_certificate,json=sendClientCertificate,proto3" json:"send_client_certificate,omitempty"`
	unknownFields                protoimpl.UnknownFields
	sizeCache                    protoimpl.SizeCache
}
...
func (x *Config) GetRequireClientCertificate() bool {
	if x != nil {
...
func (x *Config) GetClientCertificateAuthorities() [][]byte {
	if x != nil {
...
func (x *Config) GetSendClientCertificate() bool {
	if x != nil {
		return x.SendClientCertificate
	}
	return false
}
...
const file_transport_internet_tls_config_proto_rawDesc = "" +
	...
	"\x0fAUTHORITY_ISSUE\x10\x02\"\xb1\b\n" +
	"\x06Config\x12%\n" +
	...
	"\x1arequire_client_certificate\x18\x17 \x01(\bR\x18requireClientCertificate\x12D\n" +
	"\x1eclient_certificate_authorities\x18\x18 \x03(\fR\x1cclientCertificateAuthorities\x126\n" +
	"\x17send_client_certificate\x18\x19 \x01(\bR\x15sendClientCertificateBs\n" +
