...
// Write counts the io.Writer path used by BufferedWriter.flushInternal.
// Embedding io.Writer alone bypasses outbound uplink counters for buffered
// protocol headers and small payloads. The multi-buffer path counts separately.
