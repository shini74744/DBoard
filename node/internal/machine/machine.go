...
func (o *Orchestrator) startNode(ctx context.Context, mn panel.MachineNode) {
	...
	// Honor the selected kernel for this machine instance. Managed routes and
	// balancing are implemented for both; never switch a core behind the user's
	// back. A genuinely incompatible inbound transport is explicitly validated.
