    ...
    private function getConfigMappings(): array
    {
        return [
            ...
            'telegram' => [
                ...
                'telegram_notify_register' => (bool) admin_setting('telegram_notify_register', 0),
                'telegram_notify_new_order' => (bool) admin_setting('telegram_notify_new_order', 0),
                'telegram_notify_renewal' => (bool) admin_setting('telegram_notify_renewal', 0),
                'telegram_admin_bound' => User::where('is_admin', 1)->whereNotNull('telegram_id')->exists()
            ],
            'app' => [
