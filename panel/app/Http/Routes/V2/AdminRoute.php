...
class AdminRoute
{
    public function map(Registrar $router)
    {
        $router->group([
            ...
            $router->post('/probe/connector', [\App\Http\Controllers\V2\Admin\ProbeController::class, 'connector']);
            $router->get('/probe/machines', [\App\Http\Controllers\V2\Admin\ProbeController::class, 'machines']);
            $router->post('/probe/migrate', [\App\Http\Controllers\V2\Admin\ProbeController::class, 'migrate']);
            // Config
            $router->group([
                'prefix' => 'config'
            ], function ($router) {
            ...
            $router->group([
                ...
                $router->post('/preview', [PlanController::class, 'preview']);
            ...
            $router->group([
                'prefix' => 'server/ruleset'
            ], function ($router) {
                $router->get('/apps', [RuleSetController::class, 'apps']);
                $router->post('/resolve', [RuleSetController::class, 'resolve']);
            ...
            $router->group([
                ...
                $router->get('/connections', [ManageController::class, 'connections']);
